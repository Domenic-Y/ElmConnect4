...
var $author$project$Connect4$Empty = {$: 'Empty'};
var $author$project$Connect4$Red = {$: 'Red'};
...
var $author$project$Connect4$init = {
	board: A2(
		$elm$core$Array$repeat,
		6,
		A2($elm$core$Array$repeat, 7, $author$project$Connect4$Empty)),
	turnColour: $author$project$Connect4$Red,
	winner: $author$project$Connect4$Empty
};
...
var $author$project$Connect4$Yellow = {$: 'Yellow'};
...
var $author$project$Connect4$rowCheck = F3(
	function (row, count, lastColour) {
		rowCheck:
		while (true) {
			if (count >= 4) {
				return true;
			} else {
				if ($elm$core$Array$isEmpty(row)) {
					return false;
				} else {
					if (_Utils_eq(
						A2(
							$elm$core$Maybe$withDefault,
							$author$project$Connect4$Empty,
							A2(
								$elm$core$Array$get,
								$elm$core$Array$length(row) - 1,
								row)),
						lastColour) && (!_Utils_eq(lastColour, $author$project$Connect4$Empty))) {
						var $temp$row = A3($elm$core$Array$slice, 0, -1, row),
							$temp$count = count + 1,
							$temp$lastColour = A2(
							$elm$core$Maybe$withDefault,
							$author$project$Connect4$Empty,
...
var $author$project$Connect4$rowCheckFliped = F3(
	function (count, lastColour, row) {
		return A3($author$project$Connect4$rowCheck, row, count, lastColour);
	});
var $author$project$Connect4$check4Across = function (board) {
	return A3(
		...
		A2(
			$elm$core$Array$map,
			A2($author$project$Connect4$rowCheckFliped, 0, $author$project$Connect4$Empty),
			board));
};
...
var $author$project$Connect4$getColumn = F2(
	function (board, xInt) {
		...
		return A2(
			...
			A2(
				$elm$core$Array$map,
				$elm$core$Array$get(xInt),
				A2(
					$elm$core$Array$map,
					$elm$core$Maybe$withDefault($elm$core$Array$empty),
					A2(
						$elm$core$Array$map,
						A2($pilatch$flip$Flip$flip, $elm$core$Array$get, board),
						yRange))));
	});
var $author$project$Connect4$rotateBoard = function (board) {
	var xRange = $elm$core$Array$fromList(
		A2($elm$core$List$range, 0, 7));
	return A2(
		$elm$core$Array$map,
		$author$project$Connect4$getColumn(board),
		xRange);
};
var $author$project$Connect4$check4Down = function (board) {
	...
	function (board, int1) {
		...
		return A2(
			...
			A3(
				...
				$elm$core$Basics$apL,
				A2($elm$core$Array$map, $elm$core$Array$get, xRange),
				A2(
					$elm$core$Array$map,
					$elm$core$Maybe$withDefault($elm$core$Array$empty),
					A2(
...
var $author$project$Connect4$rotateBoardNeg15 = function (board) {
	var xRange = $elm$core$Array$fromList(
		A2($elm$core$List$range, -3, 2));
	return A2(
		$elm$core$Array$map,
...
var $author$project$Connect4$rotateBoardPos15 = function (board) {
	var xRange = $elm$core$Array$fromList(
		A2($elm$core$List$range, 3, 8));
	return A2(
		$elm$core$Array$map,
		$author$project$Connect4$getPosDiagonals(board),
		xRange);
};
var $author$project$Connect4$checkPosDiagonals = function (board) {
	return $author$project$Connect4$check4Across(
		$author$project$Connect4$rotateBoardPos15(board));
};
var $author$project$Connect4$check4s = function (board) {
	return $author$project$Connect4$check4Across(board) || ($author$project$Connect4$check4Down(board) || ($author$project$Connect4$checkPosDiagonals(board) || $author$project$Connect4$checkNegDiagonals(board)));
};
...
var $author$project$Connect4$updateArray = F4(
	function (colInt, rowInt, board, colour) {
		updateArray:
		while (true) {
			var unitPiece = A2(
				$elm$core$Maybe$withDefault,
				...
				A2(
					...
					A2(
						...
						A2($elm$core$Array$get, rowInt, board))));
			var newRow = A3(
				$elm$core$Array$set,
				colInt,
				colour,
			...
			if ((colInt < 0) || (rowInt < 0)) {
				...
				if (_Utils_eq(unitPiece, $author$project$Connect4$Red) || _Utils_eq(unitPiece, $author$project$Connect4$Yellow)) {
					var $temp$colInt = colInt,
						$temp$rowInt = rowInt - 1,
						$temp$board = board,
						$temp$colour = colour;
					colInt = $temp$colInt;
					rowInt = $temp$rowInt;
					board = $temp$board;
					colour = $temp$colour;
					continue updateArray;
				} else {
					return A3($elm$core$Array$set, rowInt, newRow, board);
				}
			}
		}
	});
var $author$project$Connect4$update = F2(
	function (msg, model) {
		var _int = msg.a;
...
var $author$project$Connect4$viewButton = function (_int) {
	return A2(
...
var $author$project$Connect4$viewColour = function (colour) {
	switch (colour.$) {
		case 'Red':
			return A2(
				$elm$html$Html$div,
...
var $author$project$Connect4$viewRow = function (row) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		$elm$core$Array$toList(
			A2($elm$core$Array$map, $author$project$Connect4$viewColour, row)));
};
var $author$project$Connect4$viewBoard = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Connect4$viewButton,
					A2($elm$core$List$range, 0, 6))),
				A2(
				$elm$html$Html$div,
				_List_Nil,
...
_Platform_export({'Connect4':{'init':$author$project$Connect4$main(
